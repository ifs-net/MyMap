...
function MyMap_userapi_getWayPoints($args)
{
    ...
    $orderBy = $column['id'];
    return DBUtil::selectObjectArray ('mymap_waypoints', $where, $orderBy);
}
...
function MyMap_userapi_getMarkers($args)
{
    ...
    $orderBy = $column['date'];
    return DBUtil::selectObjectArray ('mymap_markers', $where, $orderBy);
}
...
function MyMap_userapi_getGPXimport($args)
{
	...
	unset($filename);
	return DBUtil::insertObjectArray($trkpts,'mymap_waypoints');
}
